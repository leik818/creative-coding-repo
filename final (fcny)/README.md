...
The data used in this section of the project were obtained from NYC Open Data and filtered to focus specifically on Manhattan Community Board 2. The primary sources include the Affordable Housing Projects database, the Owned and Leased Property dataset, and the Historic Districts shapefile, each of which provided the spatial and attribute information relevant to the analysis.
